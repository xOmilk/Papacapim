...
import 'package:flutter_project/ui/components/list_followers_modal.dart';
  ...
  void initState() {
    ...
    user.then((value) {
      ...
      setState(() {
        ...
        followersNumber = value.followersNumber ?? 0;
      });
    });
  }
      ...
      body: FutureBuilder<UserResponse?>(
        ...
        builder: (context, snapshot) {
          ...
          return RefreshIndicator(
            onRefresh: () {
              return ref.refresh(myPostsProvider((user.login)).future);
            },
